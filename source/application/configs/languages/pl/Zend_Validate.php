...
return array(
    ...
    "'%value%' was not found in the haystack" => "Nie znaleziono wartości '%value%' bazy danych",
    ...
    "Captcha value is wrong" => "Captcha wartość jest nie tak",
    //Mtt_Validate_PasswordCoinciden
