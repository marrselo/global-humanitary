...
return array(Zend_Validate_NotEmpty::IS_EMPTY => 'Este campo es obligatorio.', 	
    ...
    Zend_Validate_File_Size::TOO_BIG=> "El máximo tamaño para la foto '%value%' es '%max%' pero se ha detectado un tamaño de '%size%'",
    Zend_Validate_File_Extension::FALSE_EXTENSION=>"El archivo'%value%' tiene una extención no válida",
    Zend_Captcha_Word::BAD_CAPTCHA =>'Código Incorrecto intente de nuevo'
